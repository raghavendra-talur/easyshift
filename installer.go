...
func NewOpenShiftInstaller(cmd CommandRunner) *OpenShiftInstaller {
...
func (i *OpenShiftInstaller) WriteInstallConfig(_ context.Context, spec InstallerSpec) error {
...
func (i *OpenShiftInstaller) CreateIgnitionConfigs(ctx context.Context, spec InstallerSpec) error {
...
func (i *OpenShiftInstaller) CreateSingleNodeIgnition(ctx context.Context, spec InstallerSpec) error {
...
func (i *OpenShiftInstaller) EmbedIgnitionInISO(ctx context.Context, spec InstallerSpec, isoPath, ignitionPath, outputPath string) error {
...
func (i *OpenShiftInstaller) WaitForInstallComplete(ctx context.Context, spec InstallerSpec) error {
...
func installerWriters(spec InstallerSpec) (stdout, stderr io.Writer) {
	if spec.Out != nil {
...
// JSON.
func (i *OpenShiftInstaller) CoreOSLiveISOURL(ctx context.Context, spec InstallerSpec) (string, error) {
